...
vim.keymap.set("n", "<C-f>", function() nav(vim.v.count > 0 and vim.v.count or 1) end, { desc = "Next buffer" })
vim.keymap.set("n", "<C-b>", function() nav(-(vim.v.count > 0 and vim.v.count or 1)) end, { desc = "Previous buffer" })
